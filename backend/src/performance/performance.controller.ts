...
export class PerformanceController {
  ...
  @ApiOperation({ summary: 'Submit a completed performance review' })
  submitReview(@Param('id') id: string, @Body() body: any) {
    return this.performance.update(id, body);
  }

  @Patch(':id/review/upload')
  @UseGuards(RolesGuard)
  @Roles('admin', 'hr_manager', 'reporting_manager')
  @UseInterceptors(FileInterceptor('file', {
    storage: diskStorage({
